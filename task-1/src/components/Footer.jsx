...
export default function Footer(){
    return(
        <footer className="bg-gray-900 text-white">
            ...
            <div>
                <input type="text" placeholder="Enter your phone no." className="text-gray-800 sm:w-72 w-full sm:mr-5 mr-1 lg:mb-0 mb-4 py-2.5 rounded px-2 focus:outline-none"></input>
